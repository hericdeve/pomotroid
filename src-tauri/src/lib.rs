...
use commands::{
    ...
    session_get, session_update, study_session_update, session_delete, session_create_manual, session_get_subjects, subjects_get_all, subject_create, subject_delete, subject_set_weekly_goal, subject_get_weekly_progress, session_get_topics, session_get_study_types, sessions_get_history, session_add_extra_time,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            subject_create,
            subject_delete,
            subject_set_weekly_goal,
            subject_get_weekly_progress,
            session_get_topics,
            session_get_study_types,
