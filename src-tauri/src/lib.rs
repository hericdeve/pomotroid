...
use commands::{
    ...
    google_calendar_set_synced_calendar, google_calendar_set_events_calendar, google_calendar_get_events_calendar,
    google_calendar_sync_now, google_calendar_get_overlay_events, subject_events_sync,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            google_calendar_set_events_calendar,
            google_calendar_get_events_calendar,
